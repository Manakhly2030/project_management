function add_efforts(frm, table, module) {
	frappe.call({
		method: 'project_management.project_management.doctype.project_requirement.project_requirement.get_process_documents',
		args: {
			module: module
		},
		callback: function(r) {
...
frappe.ui.form.on('Project Requirement', {
	...
	make_quotation(frm) {
		frappe.model.open_mapped_doc({
			method: "project_management.project_management.doctype.project_requirement.project_requirement.make_quotation",
			frm: frm,
		});
	},
	make_sales_order(frm) {
		frappe.model.open_mapped_doc({
			method: "project_management.project_management.doctype.project_requirement.project_requirement.make_sales_order",
			frm: frm,
		});
	},
	make_project(frm) {
		frappe.model.open_mapped_doc({
			method: "project_management.project_management.doctype.project_requirement.project_requirement.make_project",
			frm: frm,
		});
	},
